...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    ModalCaptureFolderForm: typeof import('./views/captures/components/ModalCaptureFolderForm.vue')['default']
    ...
    ModalCreateProject: typeof import('./views/dashboard/components/ModalCreateProject.vue')['default']
